# Protocolo de classificação das Competências do Pensamento Computacional

O protocolo de classificação foi iterativamente refinado ao longo do experimento, buscando adaptar as definições de cada competência ao formato de questões do exame POSCOMP. 
